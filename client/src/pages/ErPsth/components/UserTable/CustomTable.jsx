...
import { Table, Switch, Icon, Button, Grid, Pagination, Upload } from '@alifd/next';
...
export default class CustomTable extends Component {
    ...
    render() {
        return (
            <IceContainer title="导入物料">
                <Row wrap style={styles.headRow}>
                    <Col l="12">
                        <Upload
                            listType="text"
                            action={`${rootUrl}/api/ERPuploadfile`} // 该接口仅作测试使用，业务请勿使用
                            accept="*"
                        ...
                        >
                            ...
                            <i style={{fontStyle: 'normal', marginLeft:'8px'}}>请上传填写完成的物料模板</i>
                        </Upload>
                    </Col>
